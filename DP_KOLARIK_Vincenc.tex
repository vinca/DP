...
Each \acrshort{NS} element consists of business logic encapsulated in a \textit{building block}. The building block executes the business logic code, as well as it provides  
