...
On the dawn of microservice architecture, it needed to be compared to the traditional single-process application --- so the word monolith received a new meaning. In this context, \textit{monolith} doesn't have the pejorative connotation, as it often represents the well structured, n-tier application (see \fullref{fig:monolith_vs_microservices}).
...
\todo{nějak se vyjádřit k tý literature review}
\begin{figure}[b]
  \centering
