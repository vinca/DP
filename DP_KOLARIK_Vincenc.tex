...
\begin{itemize}
    ...
    \item \textbf{Topology doesn't change}, and \textbf{the network is homogeneous} \todo{odkazat na service discovery nebo nejak ukecat}
...
\begin{figure}
	\dirtree{%
        ...
        .1 Text\DTcomment{thesis text}.
            .2 DP Kolarik Vincenc.pdf\DTcomment{PDF version of~the~thesis}.
